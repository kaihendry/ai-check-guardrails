// # bypass
//
// Scans shell history files for use of permission-bypass flags in Claude CLI invocations.
// Running Claude with --dangerously-skip-permissions disables safety guardrails and is a
...
//
// Scanned history files (in order): ~/.zsh_history, ~/.bash_history, ~/.history.
// Detected flags: --dangerously-skip-permissions, --dangerously_skip_permissions.
//
// # Configuration
//
