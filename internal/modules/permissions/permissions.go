// # permissions
//
// Checks whether ~/.claude/settings.json contains explicit permission or tool-access
// configuration. Without defined restrictions, Claude may use any available tool without
// constraints.
//
// # Findings
//
...
//
// The module looks for any of these keys in settings.json: permissions, allowedTools,
// blockedTools, allow, deny. If any one is present, no finding is emitted.
//
// # Configuration
//
