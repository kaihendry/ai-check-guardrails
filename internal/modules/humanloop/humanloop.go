// # humanloop
//
// Checks whether a human-in-the-loop confirmation setting is present in
// ~/.claude/settings.json. Without explicit confirmation requirements, Claude may take
// consequential actions without pausing for human review.
//
// # Findings
//
...
//
// The module looks for any of these keys in settings.json: requireConfirmation,
// humanInTheLoop, confirmDangerousActions. If any one is present, no finding is emitted.
//
// # Configuration
//
